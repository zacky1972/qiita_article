...
tags:
  ...
  - oop
private: true
updated_at: '2014-10-09T09:37:51+09:00'
id: 375479a7f4c02ebfb9e9
...
## まとめ
今回は状態機械モデリングの方法について説明しました。
* [イベントをリストアップする](http://qiita.com/zacky1972/private/aa39be058c86ea8a2373)
* [イベントに対応するアクションを考える](http://qiita.com/zacky1972/private/4c4560214c1cc2d40ae5)
* [状態を認識する](http://qiita.com/zacky1972/private/833d4a81695db93404db)
* [状態間の遷移を定義する](http://qiita.com/zacky1972/private/f55ba97d5de5576d39dc)
* [同じ振る舞いをする状態を1つにまとめる](http://qiita.com/zacky1972/private/744e7939458de50b50fa)
* [状態機械モデリングの終了条件を判定する](http://qiita.com/zacky1972/private/c1ad11537201cfbadc64)
