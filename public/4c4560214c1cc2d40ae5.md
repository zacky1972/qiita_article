...
tags:
  ...
  - oop
private: true
updated_at: '2014-10-09T09:36:30+09:00'
id: 4c4560214c1cc2d40ae5
...
## イベントをリストアップする
状態機械モデリングをするにあたって，まず最初に行うのは，イベント (event) あるいはトリガー(trigger)のリストアップです。イベントとは，システムに何らかの変化を促す入力のことです。電卓の場合，イベントの具体例としては，ボタンを押す操作が挙げられます。なぜならば電卓のボタンを押すと，ディスプレイに何らかの反応があるなどの変化があるからです。

ではさっそくどんなイベントがあるのか，リストアップしてみましょう。

もし，このヒントに着想を得て，状態機械モデリングが続けられるならば，自力で挑戦してみてください。このあとで何をしたらいいか10分以上考えてもわからなかったら，[次のページに進んでヒントを読んでください。](http://qiita.com/zacky1972/private/a01c6023415935a4b6b4)
